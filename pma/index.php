                    ...
                    <form id="get-offers-form2" action="" class="offers-form" method="post">
                        <div class="offers-form__wrapper">
                            ...
                            <div class="check-box__control">
                                <input required="required" type="checkbox" id="check-box" name="accept">
...
if ($_POST) {
    ...
    if (isset($names[1])) {
        ...
        echo 'alert("Введите ФИО полностью")';
        echo '</script>';
    }
    ...
    if ($_POST['accept'] != true) {
        echo '<script language="javascript">';
        echo 'alert("Вы должны согласится с условиями обработки и использования персональных данных")';
        echo '</script>';
    } else {
        ...
        if ($anketa['surname'] && $anketa['name'] && $anketa['passport'] && $anketa['mobile_phone'] && $city_id) {
